package com.rqb.crm.manager.common.base.service.impl;
...
@Transactional
public abstract class BaseServiceImpl<T extends BaseDTO, ID extends Serializable> implements IBaseService<T, ID> {
