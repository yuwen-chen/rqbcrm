package com.rqb.crm.manager.system.controller.admin.system;
...
//		}
		Page<RoleDTO> page = roleService.findAllByLike(searchText, getPageRequest());
		return page;
	}
	...
	public String edit(@PathVariable Integer id,ModelMap map) {
		RoleDTO roleDTO = roleService.find(id);
	...
	@ResponseBody
	public JsonResult edit(RoleDTO roleDTO,ModelMap map){
		try {
