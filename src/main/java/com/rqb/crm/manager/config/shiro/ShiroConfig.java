package com.rqb.crm.manager.config.shiro;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		List<com.rqb.crm.manager.system.dto.ResourceDTO> list = resourceService.findAll();
		for (com.rqb.crm.manager.system.dto.ResourceDTO resource : list) {
