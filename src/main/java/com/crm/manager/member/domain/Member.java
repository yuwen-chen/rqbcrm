...
public class Member {
	...
	public String toString() {
		return "Member [id=" + id + ", realName=" + realName + ", phone=" + phone + ", indentityType=" + indentityType
				+ ", indentityNo=" + indentityNo + ", sex=" + sex + ", userStatus=" + userStatus + ", address="
				+ address + ", email=" + email + ", appPlatform=" + appPlatform + ", financialLevel=" + financialLevel
				+ ", registerDate=" + registerDate + ", memberTable=" + memberTable + "]";
	}
